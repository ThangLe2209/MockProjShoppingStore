...
{
    options.IdleTimeout = TimeSpan.FromMinutes(30); // time for session exists - 30 minutes will expires
...
//{
//	client.BaseAddress = new Uri(builder.Configuration["ShoppingStoreAPIRoot"]);
//	client.DefaultRequestHeaders.Clear();
//	client.DefaultRequestHeaders.Add(HeaderNames.Accept, "application/json");
//});

// API HttpClient
builder.Services.AddHttpClient<ShoppingStoreService>().AddUserAccessTokenHandler();
